"use strict";var c=function(i,r){return function(){try{return r||i((r={exports:{}}).exports,r),r.exports}catch(t){throw (r=0, t)}};};var w=c(function(U,p){
var j=require('@stdlib/assert-is-plain-object/dist'),h=require('@stdlib/assert-has-own-property/dist'),C=require('@stdlib/assert-is-positive-integer/dist').isPrimitive,b=require('@stdlib/error-tools-fmtprodmsg/dist');function N(i,r){return j(r)?(h(r,"thisArg")&&(i.thisArg=r.thisArg),h(r,"limit")&&(i.limit=r.limit,!C(i.limit))?new TypeError(b('1xX3P',"limit",i.limit)):null):new TypeError(b('1xX2V',r));}p.exports=N
...
var B=require('@stdlib/assert-is-function-array/dist'),D=require('@stdlib/assert-is-function/dist'),E=require('@stdlib/error-tools-fmtprodmsg/dist'),G=require('@stdlib/constants-float64-pinf/dist'),H=w(),J=A();function K(i,r){var t,n;if(!B(i))throw new TypeError(E('1xXAl',i));if(t={limit:G},arguments.length>1&&(n=H(t,r),n))throw n;return l;function l(u){if(!D(u))throw new TypeError(E('1xX2b',u));return J(i,t,s);function s(e,a){if(e)return u(e);u(null,a)}}}F.exports=K
