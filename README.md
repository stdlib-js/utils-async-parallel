...
```javascript
import parallel from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-async-parallel@v0.1.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-async-parallel@v0.1.1-esm/index.mjs';
```
